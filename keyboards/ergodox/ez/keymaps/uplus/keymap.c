 ...
 * |--------+------+------+------+------+------+------|     |------+------+------+------+------+------+--------|
 * |Tab/Hyp |   Q  |   W  |   E  |   R  |   T  | TAB  |     |  -   |   Y  |   U  |   I  |   O  |   P  |   BS   |
 * |--------+------+------+------+------+------|      |     |      |------+------+------+------+------+--------|
...
[SYMB] = KEYMAP(
    ...
    _______, KC_CIRC, KC_DLR,  KC_LBRC, KC_RBRC,  _______,  KC_TILD,
...
[MISC] = KEYMAP(
       ...
       _______, KC_MPRV, KC_MPLY, KC_MNXT, KC_PGDN, _______, _______,
       _______, _______, _______, _______, _______,
                                                    _______, _______,
                                                             _______,
                                           _______, _______, _______,
