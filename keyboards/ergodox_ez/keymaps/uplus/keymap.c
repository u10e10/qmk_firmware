...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [BASE] = KEYMAP(  // layer 0 : default
            ...
            KC_EQL,     KC_N,     KC_M,    KC_COMM, KC_DOT,  KC_SLSH,  LT_3(BSLS),
     ...
     * |--------+------+------+------+------+------+------|     |------+------+------+------+------+------+--------|
     * |        | Mclk |WBack | MUp  | WFwd | G(R) |      |     |      |CA_Lft|CA_Dwn|CA_Up |CA_Rht|      |        |
     * |--------+------+------+------+------+------|      |     |      |------+------+------+------+------+--------|
     * |        | Lclk |MsLeft|MsDown|MsRght| WhUp |------|     |------|GA_Lft|GA_Dwn|GA_Up |GA_Rht|      |        |
     * |--------+------+------+------+------+------|      |     |      |------+------+------+------+------+--------|
     * |        | Rclk |WhLeft| G(M) |WhRght|WhDown|      |     |      | G_Lft| G_Dwn| G_Up | G_Rht|      |        |
     * `--------------------------------------------------'     `--------------------------------------------------'
     *                                                          .-------------.
     *                                                          | ACL0 | ACL0 |
     */
     ...
     * |--------+------+------+------+------+-------------|     |------+------+------+------+------+------+--------|
     * |        |   7  |   8  |   9  |  10  |  11  |  12  |     | H_F  | H_E  |VolDn | Mute |VolUp |      |        |
     * |--------+------+------+------+------+------|      |     |      |------+------+------+------+------+--------|
     * |        |  BS  | PgUp | Del  |      |      |------|     |------| H_A  | H_B  | H_C  | H_D  |  **  |        |
     * |--------+------+------+------+------+------|AltF4 |     | H_G  |------+------+------+------+------+--------|
     * |        |WBack | PgDw | WFwd |      |      |      |     |      |      | Prev | Play | Next |      |        |
     * `--------+------+------+------+------+-------------'     `-------------+------+------+------+------+--------'
     */
    [MISC] = KEYMAP(
            _______, KC_1,    KC_2,    KC_3,    KC_4,    KC_5,    XXXXXXX,
            _______, KC_6,    KC_7,    KC_8,    KC_9,    KC_0,    XXXXXXX,
            _______, KC_BSPC, KC_DELT, KC_PGUP, CA(T),   XXXXXXX,
            _______, KC_WBAK, KC_PGDN, KC_WFWD, CA(Y),   XXXXXXX, LALT(KC_F4),
            _______, _______, _______, _______, _______,
            _______, _______,
            _______,
            _______, _______, _______,
            ...
            H(F),    XXXXXXX, KC_VOLD, KC_MUTE, KC_VOLU, _______, _______,
                     H(A),    H(B),    H(C),    H(D),    _______, _______,
            H(G),    H(E),    KC_MPRV, KC_MPLY, KC_MNXT, _______, _______,
            _______, _______, _______, _______, _______,
            _______, _______,
            _______,
            _______, _______, _______),
