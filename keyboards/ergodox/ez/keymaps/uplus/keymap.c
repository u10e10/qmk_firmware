...
[SYMB] = KEYMAP(
    ...
    _______, KC_EXLM, KC_AT,   KC_LBRC, KC_RBRC,  KC_PERC, _______,
    _______, KC_BSPC, KC_DELT, KC_LCBR, KC_RCBR,  KC_GRV,
    _______, KC_CIRC, KC_DLR,  KC_LPRN, KC_RPRN,  KC_TILD, KC_TILD,
