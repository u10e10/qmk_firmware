...
//      _______, _______, _______, _______, _______, _______, _______,          _______, _______, _______, _______, _______, _______, _______,
    ...
    [BASE] = LAYOUT_moonlander(
        KC_APP,  KC_1,    KC_2,    KC_3,    KC_4,    KC_5,    KC_BSPC,          XXXXXXX, KC_6,    KC_7,    KC_8,    KC_9,    KC_0,    DM_RSTP,
    ...
    [MISC] = LAYOUT_moonlander(
        ...
        _______, KC_BTN3, KC_WBAK, KC_MS_U, KC_WFWD, G(R),    _______,          _______, GC(LEFT),GC(DOWN),GC(UP),  GC(RGHT),XXXXXXX, KC_FN11,
