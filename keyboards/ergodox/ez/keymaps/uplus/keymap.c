 ...
 * |--------+------+------+------+------+------+------|     |------+------+------+------+------+------+--------|
 * |  Alt   |   Q  |   W  |   E  |   R  |   T  | TAB  |     |  -   |   Y  |   U  |   I  |   O  |   P  |   -    |
 * |--------+------+------+------+------+------|      |     |      |------+------+------+------+------+--------|
 * |Ent/Alt |   A  |   S  |   D  |   F  |   G  |------|     |------|   H  |   J  |   K  |   L  |   ;  |  '/L2  |
 * |--------+------+------+------+------+------|  `   |     |  =   |------+------+------+------+------+--------|
 * |  Esc   |   Z  |   X  |   C  |   V  |   B  |      |     |      |   N  |   M  |   ,  |   .  |   /  |   \    |
 * |--------+------+------+------+------+-------------'     `-------------+------+------+------+------+--------|
 ...
 */
  [SYMB] = KEYMAP(
      ...
      _______, KC_BSPC, KC_DELT, KC_LCBR, KC_RCBR,  KC_TILD,
 ...
 * |--------+------+------+------+------+------+------|     |------+------+------+------+------+------+--------|
 * |        | G(R) |WBack | MUp  | WFwd | G(M) |      |     | H_F  | H_E  |VolDn | Mute |VolUp |      |        |
 * |--------+------+------+------+------+------|      |     |      |------+------+------+------+------+--------|
 * |        | Lclk |MsLeft|MsDown|MsRght| WhUp |------|     |------| H_A  | H_B  | H_C  | H_D  |  **  |        |
 * |--------+------+------+------+------+------|      |     | H_G  |------+------+------+------+------+--------|
 * |        | Rclk |WhLeft|      |WhRght|WhDown|      |     |      |      | Prev | Play | Next |      |        |
 * `--------------------------------------------------'     `--------------------------------------------------'
 *                                                          .-------------.
 *                                                          | ACL0 | ACL0 |
 */
  [MDIA] = KEYMAP(
      ...
      _______, G(R),    KC_WBAK, KC_MS_U, KC_WFWD, G(M),    _______,
 ...
 */
  [MISC] = KEYMAP(
      ...
      _______, KC_BSPC, KC_DELT, KC_WBAK, KC_PGUP, KC_WFWD,
      _______, KC_MPRV, KC_MPLY, KC_MNXT, KC_PGDN, _______, LALT(KC_F4),
      _______, _______, _______, _______, _______,
      _______, _______,
      _______,
      _______, _______, _______,
